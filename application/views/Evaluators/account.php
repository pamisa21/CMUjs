  ...
  <div class="cardcontainer">
    <div class="profile-body">
      ...
      <div class="profile">
        ...
        <h2 class="name"><?php echo $users['complete_name']; ?></h2>
        <!-- Displaying author's location -->
        <h3 class="locationname"><i class="fas fa-map-marker-alt"></i> <?php echo $users['address']; ?></h3>
        <!-- Displaying author's email -->
        <h3 class="email"><i class="fas fa-envelope-square"></i> <?php echo $users['email']; ?></h3>
        <!-- Displaying author's description -->
        <p class="descricao"><?php echo $users['description']; ?></p>
