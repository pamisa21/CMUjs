    ...
    <div class="column column-1">
        <div class="card">
            ...
            <div class="articlebio">
                  <p class="Title"> Volume 1 </p>
                  
                  <p class="description">   Vol. 27 No. 2 (2023) presents a diverse array of original articles covering various topics in research and analysis. Articles include investigations into communication styles among Mobile Legends Bang-Bang players, a proposed conceptual framework for integrating agent-based microsimulation into demand models,</p>
        ...
        <div class="volume">
            <div class="volumearticle">
              ...
              <ul class="articlelist">
                <li onclick="showArticle('Volume 1')"><span class="icon-volume"></span> Article 1</li>
                <li onclick="showArticle('Volume 2')"><span class="icon-volume"></span> Article 2</li>
                <li onclick="showArticle('Volume 3')"><span class="icon-volume"></span> Article 3</li>
                <li onclick="showArticle('Volume 4')"><span class="icon-volume"></span> Article 4</li>
                <li onclick="showArticle('Volume 5')"><span class="icon-volume"></span> Article 5</li>
              </ul> 
            </div>
            <div class="volumearticle">
              <h4> Volume 2 </h4>
